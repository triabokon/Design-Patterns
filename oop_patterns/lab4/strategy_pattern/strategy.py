...
class RegularStatus(Status):
    @staticmethod
    def access():
        str = "You are our Regular visitor and for you available theese parts:\n"
        for i in range(3):
            str += Status.conf_parts[i] + ", "
        return str[:-2]
...
class SuperRegularStatus(Status):
    @staticmethod
    def access():
        str = "You are our Super Regular visitor and for you available theese parts:\n"
        for i in range(4):
            str += Status.conf_parts[i] + ", "
        return str[:-2]
...
class HonorableStatus(Status):
    @staticmethod
    def access():
        str = "You are our Honorable visitor and for you available theese parts:\n"
        for i in range(5):
            str += Status.conf_parts[i] + ", "
        return str[:-2]
